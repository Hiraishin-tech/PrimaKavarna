...
$config = array(
    ...
    */
    ...
    |
    */
    'upload_dir' => dirname(dirname(dirname(dirname(dirname($_SERVER['PHP_SELF']))))).'/upload/source/',
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    |
    */
    'thumbs_upload_dir' => dirname(dirname(dirname(dirname(dirname($_SERVER['PHP_SELF']))))).'/upload/thumbs/',
